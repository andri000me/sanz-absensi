...
class Karyawan extends CI_Controller {
    ...
    public function download_absensi() {
        $data['karyawan'] = $this->karyawan->get_absensi_karyawan();
        $this->load->view('admin/Absensi_download', $data);
    }

    function download_absensi_excel(){
        $data['karyawan'] = $this->karyawan->get_absensi_karyawan();
        $this->load->view('admin/Download_absensi_excel', $data);
    }
